/**
 * Text outline normalizer for printable exports
 * Normalizes text-outline elements before export to ensure consistent rendering
 */

import type { ITextOutlineNormalizer } from '../types'

export class TextOutlineNormalizer implements ITextOutlineNormalizer {
